            ...
            <div className='reviews-item-info'>
                <div className='reviews-item-info-desc'>
                    ...
                    <div className='reviews-item-info-desc-rate'>
                        {rew.rate==="5" && (<div><img src={GoldStar}/><img src={GoldStar}/><img src={GoldStar}/><img src={GoldStar}/><img src={GoldStar}/></div>)}
                        {rew.rate==="4" && (<div><img src={GoldStar}/><img src={GoldStar}/><img src={GoldStar}/><img src={GoldStar}/><img src={GrayStar}/></div>)}
                        {rew.rate==="3" && (<div><img src={GoldStar}/><img src={GoldStar}/><img src={GoldStar}/><img src={GrayStar}/><img src={GrayStar}/></div>)}
                        {rew.rate==="2" && (<div><img src={GoldStar}/><img src={GoldStar}/><img src={GrayStar}/><img src={GrayStar}/><img src={GrayStar}/></div>)}
                        {rew.rate==="1" && (<div><img src={GoldStar}/><img src={GrayStar}/><img src={GrayStar}/><img src={GrayStar}/><img src={GrayStar}/></div>)}
                    </div>
                </div>
