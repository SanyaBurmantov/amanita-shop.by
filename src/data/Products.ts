...
export const products: IProduct[] = [
    {
        ...
        form: 1,
        title: 'Помогает уснуть, укрепляет имунитет, снимает напряжение, увеличивает силу.',
    ...
    },
    {
        ...
        form: 1,
        title: 'Мухомор пантерный в веганских капсулах. Пантерный мухомор в 4-5 раз сильнее красного, поэтому принимать его стоит внимательно.',
        text: 'Собирались в чистых лесах Беларуси. Наш мухомор сохраняет максимальное количество полезных свойств. Сушка до 45 градусов. 2 месяца ферментации в вакууме без поступления воздуха. Капсулы делаются только из лучший шляпок мухомора.',
        type: 'Порошок',
        more: [
            {
